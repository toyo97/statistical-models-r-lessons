---
title: "Intro R"
author: "Vittorio Zampinetti^[vittorio.zampinetti@polito.it]"
date: "2022-09-26"
output: 
  bookdown::gitbook:
    config:
...
in the same continent of the four selected countries.
...
dnorm(normal_samples, mean = 2, sd = 1) # compute the density function (over another Normal)
pnorm(normal_samples, mean = 0, sd = 1) # cumulative distribution function

qnorm(c(0.05, 0.95), mean = 0, sd = 1) # get the quantiles of a normal
```
...
dir()
```
RStudio typically does all of this automatically.

You can also read function helpers simply by typing `?function_name`; this
will open formatted page with information about a specific R function or object.
